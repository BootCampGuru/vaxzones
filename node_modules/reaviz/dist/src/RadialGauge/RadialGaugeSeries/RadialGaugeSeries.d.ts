...
export declare class RadialGaugeSeries extends Component<RadialGaugeSeriesProps> {
    ...
    renderGauge(point: ChartShallowDataShape, index: number, columns: number, height: number, width: number, xScale: any, yScale: any): JSX.Element;
    render(): JSX.Element;
}
